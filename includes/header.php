...
<head>
    ...
    <style>
        /* Fix for mobile navbar toggler visibility on scroll */
        .sticky-menu .mobile-menu {
            position: relative;
            z-index: 9999;
        }

        .sticky-menu .mean-bar .meanmenu-reveal {
            color: #253c80 !important;
        }

        .sticky-menu .mean-bar .meanmenu-reveal span {
    ...
    <header class="header-area header-three">
                            ...
                            <ul>
                                <li>
                                    <div class="call-box">
                                        ...
                                        <div class="text">
                                            <span>Call Now !</span>
                                            <strong><a href="tel:+91-5842-280210">+91-5842-280210</a></strong>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="call-box">
                                        ...
                                        <div class="text">
                                            <span>Email Now</span>
                                            <strong><a href="mailto:info@example.com"> fnscnspn@gmail.com </a></strong>
                                        </div>
                                    </div>
                                </li>
                            </ul>
     ...
     style="display:flex; justify-content:flex-end; margin-left:auto;">
                        ...
                        <!-- <div class="col-xl-3 col-lg-3 text-right d-none d-lg-block text-right text-xl-right">
                            <div class="login">
                                <ul>
                                    <li><a href="#" class="menu-tigger"><i class="fa-solid fa-phone"></i></a></li>
                                    <li>
    ...
    <div class="offcanvas-menu">
        ...
        <div id="cssmenu3" class="menu-one-page-menu-container">
            <ul class="menu">
                ...
                <li class="menu-item menu-item-type-custom menu-item-object-custom"><a href="projects.html">Gallery</a>
                </li>
