...
<main>
    ...
    <section class="event pt-120 pb-90 p-relative fix">
        <div class="animations-06"><img src="/projects/Florence/assets/images/bg/an-img-sixth.png" alt="an-img-01">
        </div>
        <div class="animations-07"><img src="/projects/Florence/assets/images/bg/an-img-seventh.png"
                alt="contact-bg-an-01"></div>
        <div class="animations-08"><img src="/projects/Florence/assets/images/bg/an-img-eighth.png"
                alt="contact-bg-an-01"></div>
        <div class="animations-09"><img src="/projects/Florence/assets/images/bg/an-img-ninth.png"
                alt="contact-bg-an-01"></div>
        <div class="container">
            <!-- <div class="row">
            ...
            <div class="row" id="eventContainer">
                ...
                <div class="col-lg-4 col-md-6  wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                    <div class="event-item mb-30 hover-zoomin">
                        <div class="thumb">
                            <a href="/projects/Florence/pages/event-detail.php"><img
                                    src="/projects/Florence/assets/images/main_page/event_one.png"
                                    alt="contact-bg-an-01"></a>
                        </div>
                        <div class="event-content">
                            <div class="date"><strong>28</strong> Dec, 2025</div>
                            <h3><a href="/projects/Florence/pages/event-detail.php"> World Health Day Awareness
                                    Program</a></h3>
                ...
                <div class="col-lg-4 col-md-6  wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                    <div class="event-item mb-30 hover-zoomin">
                        <div class="thumb">
                            <a href="/projects/Florence/pages/event-detail.php"><img
                                    src="/projects/Florence/assets/images/main_page/event_two.png"
                                    alt="contact-bg-an-01"></a>
                        </div>
                        <div class="event-content">
                            <div class="date"><strong>2</strong> Jan, 2026</div>
                            <h3><a href="/projects/Florence/pages/event-detail.php">Clinical Skills & Simulation
                                    Workshop</a>
                            </h3>
                ...
                <div class="col-lg-4 col-md-6  wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                    <div class="event-item mb-30 hover-zoomin">
                        <div class="thumb">
                            <a href="/projects/Florence/pages/event-detail.php"><img
                                    src="/projects/Florence/assets/images/main_page/event_three.png"
                                    alt="contact-bg-an-01"></a>
                        </div>
                        <div class="event-content">
                            <div class="date"><strong>15</strong> Jan, 2026</div>
                            <h3><a href="/projects/Florence/pages/event-detail.php"> Community Health Outreach Camp</a>
                            </h3>
